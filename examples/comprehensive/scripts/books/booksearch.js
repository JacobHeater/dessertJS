(function () {
    ...
    function main() {
        return function initBookSearch(app) {
                    ...
                    var getBookDetail = function () {
                        ...
                        $.get(encodeURI(url))
                            .then(function (data) {
                                ...
                                displayBooks.dsrt.repeat(data.items, module.template('books/books-simple'), {
                                    clear: true
                                });
                            })
                            .then(function () {
                ...
                this.init = function () {
                    ...
                    $.get(encodeURI(url))
                        .then(function (data) {
                            ...
                            displayBooks.dsrt.repeat(data.items, module.template('books/books-detailed'), {
                                clear: true
                            });
                        });
                };
